...
//                 </Link>
//                     <h1 className="font-black text-center text-2xl border-black border-4 border-solid z-10 mx-12 mt-5">TURQUESA</h1>
//                     <img src="src/img/p00.jpeg" alt="" className="border-black border-4 border-solid z-50" />
