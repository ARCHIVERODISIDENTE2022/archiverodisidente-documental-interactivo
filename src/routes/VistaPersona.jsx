...
import imgPersona from "../assets/img/obj1.jpeg"
  ...
  return (
    <>
      <div className="personaContainer">
          ...
          <h1 className="nombrePersona"> Turquesa {participante.nombreParticipante}</h1>
          <img src= {imgPersona} alt="" className="imgPersona" /></main>
